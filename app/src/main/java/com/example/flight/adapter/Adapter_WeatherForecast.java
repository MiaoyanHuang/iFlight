...
public class Adapter_WeatherForecast extends RecyclerView.Adapter<Adapter_WeatherForecast.WeatherViewHolder> {
    ...
    public WeatherViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        WeatherViewHolder departureWeatherViewHolder = new WeatherViewHolder(view);
        return departureWeatherViewHolder;
    }
    ...
    public String transformTimeStamp(String time){ // 将时间戳转换为日期
        ...
        String dateString = formatter.format(date);  // Format the date as a string
        return dateString;  // Print the formatted date string
    }
